...
public class NovaParserModule extends AbstractModule {
   ...
   public static class ServerAdapter implements JsonDeserializer<Server> {
      ...
      private static class ServerInternalWithoutImage extends Server {
         @ConstructorProperties({
               "id", "name", "links", "uuid", "tenant_id", "user_id", "updated", "created", "hostId", "accessIPv4", "accessIPv6", "status", "flavor", "key_name", "config_drive", "addresses", "metadata", "extendedStatus", "extendedAttributes", "OS-DCF:diskConfig", "OS-EXT-AZ:availability_zone"
         })
