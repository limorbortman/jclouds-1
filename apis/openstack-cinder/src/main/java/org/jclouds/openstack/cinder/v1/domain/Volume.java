...
public class Volume {
   ...
   public static enum Status {
      CREATING, AVAILABLE, ATTACHING, DETACHING, IN_USE, DELETING, DELETED, BACKING_UP, RESTORING_BACKUP, ERROR, ERROR_DELETING, ERROR_ATTACHING, ERROR_DETACHING, ERROR_RESTORING, UNRECOGNIZED;
