...
public class ExtraDhcpOption {
   ...
   public static class Builder {
       ...
       *
       * @return the Builder.
       * @see  org.jclouds.openstack.neutron.v2.domain.ExtraDhcpOption#getId()
       */
       ...
       *
       * @return the Builder.
       * @see  org.jclouds.openstack.neutron.v2.domain.ExtraDhcpOption#getOptionName()
       */
       ...
       *
       * @return the Builder.
       * @see  org.jclouds.openstack.neutron.v2.domain.ExtraDhcpOption#getOptionValue()
       */
