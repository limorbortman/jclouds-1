 ...
 */
@Singleton
public class ParseSecurityGroupRules extends ParseJson<SecurityGroupRules> {

   @Inject
   public ParseSecurityGroupRules(Json json) {
      super(json, TypeLiteral.get(SecurityGroupRules.class));
   }
}
