...
public class Router extends ReferenceWithName {
   ...
   public abstract static class Builder<T extends Builder<T>> extends ReferenceWithName.Builder<T> {
      ...
      /**
       * @see  org.jclouds.openstack.neutron.v2_0.domain.Router#getAdminStateUp()
       */
      ...
      /**
       * @see  org.jclouds.openstack.neutron.v2_0.domain.Router#getState()
       */
      ...
      /**
       * @see  org.jclouds.openstack.neutron.v2_0.domain.Router#getExternalGatewayInfo()
       */
