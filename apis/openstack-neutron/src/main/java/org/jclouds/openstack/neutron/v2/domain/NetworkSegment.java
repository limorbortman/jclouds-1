...
public class NetworkSegment {
   ...
   public static class Builder {
       ...
       *
       * @return the Builder.
       * @see  org.jclouds.openstack.neutron.v2.domain.NetworkSegment#getNetworkType()
       */
       ...
       *
       * @return the Builder.
       * @see  org.jclouds.openstack.neutron.v2.domain.NetworkSegment#getPhysicalNetwork()
       */
       ...
       *
       * @return the Builder.
       * @see  org.jclouds.openstack.neutron.v2.domain.NetworkSegment#getSegmentationId()
       */
