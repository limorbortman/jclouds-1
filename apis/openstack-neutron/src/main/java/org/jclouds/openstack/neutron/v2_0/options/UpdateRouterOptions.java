...
public class UpdateRouterOptions implements MapBinder {
   ...
   public abstract static class Builder<T extends Builder<T>> {
      ...
      /**
       * @see  org.jclouds.openstack.neutron.v2_0.options.UpdateRouterOptions#getName()
       */
      ...
      /**
       * @see  org.jclouds.openstack.neutron.v2_0.options.UpdateRouterOptions#getAdminStateUp()
       */
      ...
      /**
       * @see  org.jclouds.openstack.neutron.v2_0.options.UpdateRouterOptions#getExternalGatewayInfo()
       */
