...
public class DockerTemplateOptions extends TemplateOptions implements Cloneable {
   ...
   public static class Builder {
      ...
      /**
       * @see org.jclouds.docker.compute.options.DockerTemplateOptions#volumes(java.util.Map)
       */
      ...
      /**
       * @see org.jclouds.docker.compute.options.DockerTemplateOptions#dns(String)
       */
      ...
      /**
       * @see org.jclouds.docker.compute.options.DockerTemplateOptions#hostname(String)
       */
      ...
      /**
       * @see org.jclouds.docker.compute.options.DockerTemplateOptions#memory(int)
       */
      ...
      /**
       * @see org.jclouds.docker.compute.options.DockerTemplateOptions#commands(Iterable)
       */
      ...
      /**
       * @see org.jclouds.docker.compute.options.DockerTemplateOptions#cpuShares(int)
       */
