...
public class BuildOptions extends BaseHttpRequestOptions {
   ...
   public static class Builder {
      ...
      /**
       * @see org.jclouds.docker.options.BuildOptions#tag
       */
      ...
      /**
       * @see org.jclouds.docker.options.BuildOptions#verbose(Boolean)
       */
      ...
      /**
       * @see org.jclouds.docker.options.BuildOptions#nocache(Boolean)
       */
